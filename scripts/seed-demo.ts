...
const COMPANIES: Row[] = [
  {
    ...
    base_currency: 'EGP',
    status: 'active',
    operating_model: 'fulfillment_center',
...
const STAFF: StaffSeed[] = [
  { employee_code: 'EMP-001', full_name: 'Amira Zaki', email: 'amira.zaki@greenops.example', phone: '+20 100 551 2210', job_title: 'Company Administrator', role: 'company_admin', department: 'OPS', team: null, status: 'active', locale: 'ar', login: true, user_type: 'employee' },
  { employee_code: 'EMP-002', full_name: 'Hossam El Din', email: 'hossam.eldin@greenops.example', phone: '+20 100 774 8890', job_title: 'Operations Manager', role: 'operations_manager', department: 'OPS', team: null, status: 'active', locale: 'ar', login: true, user_type: 'employee' },
  { employee_code: 'EMP-003', full_name: 'Nourhan Mostafa', email: 'nourhan.mostafa@greenops.example', phone: '+20 111 220 3341', job_title: 'Confirmation Team Leader', role: 'confirmation_team_leader', department: 'CONF', team: 'CONF-A', status: 'active', locale: 'ar', login: true, user_type: 'employee' },
  { employee_code: 'EMP-004', full_name: 'Mahmoud Serag', email: 'mahmoud.serag@greenops.example', phone: '+20 122 118 9902', job_title: 'Confirmation Agent', role: 'confirmation_agent', department: 'CONF', team: 'CONF-A', status: 'active', locale: 'ar', login: true, user_type: 'employee' },
  { employee_code: 'EMP-005', full_name: 'Rana Kamal', email: 'rana.kamal@greenops.example', phone: '+20 128 664 7710', job_title: 'Confirmation Agent', role: 'confirmation_agent', department: 'CONF', team: 'CONF-A', status: 'active', locale: 'ar', login: false, user_type: 'employee' },
  { employee_code: 'EMP-006', full_name: 'Omar Sherif', email: 'omar.sherif@greenops.example', phone: '+20 106 903 5528', job_title: 'Confirmation Agent', role: 'confirmation_agent', department: 'CONF', team: 'CONF-B', status: 'on_leave', locale: 'ar', login: false, user_type: 'employee' },
  { employee_code: 'EMP-007', full_name: 'Dalia Ashraf', email: 'dalia.ashraf@greenops.example', phone: '+20 109 337 4416', job_title: 'Warehouse Manager', role: 'warehouse_manager', department: 'WH', team: 'WH-PICK', status: 'active', locale: 'ar', login: true, user_type: 'employee' },
  { employee_code: 'EMP-008', full_name: 'Sayed Ibrahim', email: 'sayed.ibrahim@greenops.example', phone: '+20 100 442 1173', job_title: 'Picker', role: 'picker', department: 'WH', team: 'WH-PICK', status: 'active', locale: 'ar', login: false, user_type: 'employee' },
  { employee_code: 'EMP-009', full_name: 'Mostafa Gamal', email: 'mostafa.gamal@greenops.example', phone: '+20 112 887 6650', job_title: 'Packer', role: 'packer', department: 'WH', team: 'WH-PICK', status: 'active', locale: 'ar', login: false, user_type: 'employee' },
  { employee_code: 'EMP-010', full_name: 'Heba Selim', email: 'heba.selim@greenops.example', phone: '+20 127 550 8834', job_title: 'Inventory Controller', role: 'inventory_controller', department: 'WH', team: null, status: 'active', locale: 'ar', login: false, user_type: 'employee' },
  { employee_code: 'EMP-011', full_name: 'Youssef Ramy', email: 'youssef.ramy@greenops.example', phone: '+20 101 229 3374', job_title: 'Customer Service Agent', role: 'customer_service_agent', department: 'CS', team: 'CS-CARE', status: 'active', locale: 'en', login: false, user_type: 'employee' },
  { employee_code: 'EMP-012', full_name: 'Mariam Fathy', email: 'mariam.fathy@greenops.example', phone: '+20 115 664 2201', job_title: 'Accountant', role: 'accountant', department: 'FIN', team: null, status: 'active', locale: 'ar', login: true, user_type: 'employee' },
  { employee_code: 'EMP-013', full_name: 'Khaled Anwar', email: 'khaled.anwar@greenops.example', phone: '+20 120 774 9915', job_title: 'Collection Officer', role: 'collection_officer', department: 'FIN', team: null, status: 'active', locale: 'ar', login: false, user_type: 'employee' },
  { employee_code: 'EMP-014', full_name: 'Injy Hatem', email: 'injy.hatem@greenops.example', phone: '+20 114 220 6673', job_title: 'Quality Auditor', role: 'quality_auditor', department: 'QA', team: null, status: 'active', locale: 'en', login: false, user_type: 'employee' },
  { employee_code: 'EMP-015', full_name: 'Ziad Refaat', email: 'ziad.refaat@greenops.example', phone: '+20 102 881 4407', job_title: 'Shipping Manager', role: 'shipping_manager', department: 'OPS', team: null, status: 'active', locale: 'ar', login: false, user_type: 'employee' },
  { employee_code: 'EMP-016', full_name: 'Farida Wagih', email: 'farida.wagih@greenops.example', phone: '+20 108 335 2294', job_title: 'Reports Analyst', role: 'reports_viewer', department: 'OPS', team: null, status: 'invited', locale: 'en', login: false, user_type: 'employee' },
  { employee_code: 'EMP-017', full_name: 'Bassem Nader', email: 'bassem.nader@greenops.example', phone: '+20 103 447 1128', job_title: 'Returns Agent', role: 'returns_agent', department: 'WH', team: null, status: 'temporarily_suspended', locale: 'ar', login: false, user_type: 'employee' },
